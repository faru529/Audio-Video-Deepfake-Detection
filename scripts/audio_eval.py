...
OUTPUT_AUDIO_DIR = "Test_audios" #create a empty folder and specify the path here to save the audio files
MODEL_PATH = r"C:\Users\FARHAT AYESHA\Desktop\final p\DeepfakeDetection\models\audio_deepfake_detector.h5"
